...
void Widget::mouseDoubleClickEvent(QMouseEvent *e)
{
    ...
    if(e->x() > 365 && e->x() < 730 && e->y() > 278 && e->y() < 556)
    {
...
void Widget::keyPressEvent(QKeyEvent *e)
{
    ...
    {
        case Qt::Key_Escape:
            this->ui->label0->setGeometry(5, 7, 358, 268);
            this->ui->label1->setGeometry(372, 7, 358, 268);
            this->ui->label2->setGeometry(5, 285, 358, 268);
            this->ui->label3->setGeometry(372, 285, 358, 268);
        break;
    }
}
